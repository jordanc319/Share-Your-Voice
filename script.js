...
window.onload = function()
{
  ...
  firebase.database().ref('Completed').set("Data is logged", function(error) {
     if (error) {
       ...
       document.getElementById("question").innerHTML = numberOfVotes.question
       document.getElementById("buttonOne").innerHTML = numberOfVotes.buttonOne.name
       document.getElementById("buttonTwo").innerHTML = numberOfVotes.buttonTwo.name
       document.getElementById("buttonThree").innerHTML = numberOfVotes.buttonThree.name
       document.getElementById("buttonFour").innerHTML = numberOfVotes.buttonFour.name
     }
  });
